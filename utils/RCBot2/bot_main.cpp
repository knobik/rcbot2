...
ConVar bot_visrevs("rcbot_visrevs","8",0,"how many revs the bot searches for visible players and enemies, lower to reduce cpu usage");
ConVar bot_pathrevs("rcbot_pathrevs","30",0,"how many revs the bot searches for a path each frame, lower to reduce cpu usage");
