...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 0.74 Beta R2 linux 260 (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 0.74 Beta R2 win32 (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
