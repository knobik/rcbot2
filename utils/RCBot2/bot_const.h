...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 0.94 BETA linux 438 (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 0.94 BETA win32 438 (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
