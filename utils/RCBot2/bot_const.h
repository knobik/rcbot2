...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 0.75 Beta R1 linux 332 (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 0.75 Beta R1 win32 (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
