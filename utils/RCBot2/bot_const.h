...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 0.91 BETA linux 432 (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 0.91 BETA win32 432 (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
