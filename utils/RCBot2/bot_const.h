...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 0.85 BETA linux 386 (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 0.85 BETA win32 386 (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
