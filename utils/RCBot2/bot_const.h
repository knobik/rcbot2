...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 0.87 BETA linux 388 (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 0.87 BETA win32 388 (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
