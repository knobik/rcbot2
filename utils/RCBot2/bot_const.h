...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 0.71 Beta linux 260 (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 0.71 (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
...
#define CONDITION_PRONE					1048576
