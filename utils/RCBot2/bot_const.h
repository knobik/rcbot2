...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S 0.80 BETA linux 380 (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S 0.80 BETA win32 380 (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
...
#define CONDITION_MAX					CONDITION_DEFENSIVE
#define CONDITION_MAX_BITS				26
